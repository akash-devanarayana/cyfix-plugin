 ...
 */
function scoreElements(baselineElement, candidateElements) {
    // Score each candidate element
    const scoredCandidates = candidateElements.map(element => {
...
function calculateSimilarityScore(baselineElement, candidateElement) {
    ...
    if (baselineElement.textContent) {
        ...
        if (candidateElement.textContent) {
            ...
            const textSimilarity = calculateTextSimilarity(baselineElement.textContent, candidateElement.textContent);

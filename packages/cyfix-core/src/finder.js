...
exports.findCandidateElements = void 0;
/**
 ...
 */
function findCandidateElements(baselineElement, currentRoot) {
...
exports.findCandidateElements = findCandidateElements;
/**
 ...
 */
function findElementsByFeatures(rootNode, features, tagName) {
    const candidates = [];
 ...
 */
function countFeatureMatches(node, features) {
    let matchCount = 0;

 ...
 */
function generateSelectors(element, rootNode) {
    const selectors = [];
 ...
 */
function isGoodSelectorAttribute(attributeName) {
 ...
 */
function estimateSelectorSpecificity(selector, rootNode) {
    ...
    else if (selector.includes('.') && ((_a = selector.match(/\./g)) === null || _a === void 0 ? void 0 : _a.length) > 1) {
 ...
 */
function generateCssPath(element, rootNode) {
 ...
 * This is a simplified implementation - a real one would be more sophisticated
 */
function generateXPath(element, rootNode) {
 ...
 */
function removeDuplicateSelectors(selectors) {
